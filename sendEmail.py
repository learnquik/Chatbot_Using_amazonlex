...
def sendEmail():
    try:
        if request.json['emailId'] is not None:
            ...
            contact_add = "abhisingh30314c@gmail.com"  ## the email id of the support team
            fromaddr = "learnquik8217@gmail.com"   ## the email id from where we are going to send the mail
            ...
            # Authentication
            s.login(fromaddr,"yourPassword") # give your password here
